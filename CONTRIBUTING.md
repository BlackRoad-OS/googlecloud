...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/googlecloud.git
cd googlecloud

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/googlecloud.git
